      ...
      <div className="container-pad py-16 grid gap-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-6 text-sm text-white/70 leading-relaxed">
            Manufacturing and distributing premium Nigerian swallow flour products to homes,
            retailers, wholesalers, and distributors across the nation.
          </p>
          <div className="flex gap-3 mt-6">
            {[Facebook, Instagram, Twitter].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="h-9 w-9 rounded-full border border-white/15 grid place-items-center hover:bg-gold hover:text-navy hover:border-gold transition-all"
              >
                <Icon size={16} />
              </a>
            ))}
        ...
        <div>
          <h4 className="font-display text-sm uppercase tracking-[0.18em] text-gold mb-5">
            Products
          </h4>
          <ul className="space-y-3 text-sm text-white/80">
            {["Semo", "Garri", "Yam Flour", "Plantain Flour", "Cassava Flour", "Baby Foods"].map(
              (p) => (
                <li key={p}>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/80">
            ...
            <li>
              <Link to="/order" className="hover:text-gold transition-colors">
                Place an Order
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/80">
            <li className="flex gap-3">
              <MapPin size={16} className="text-gold shrink-0 mt-0.5" /> Lagos, Nigeria
            </li>
            <li className="flex gap-3">
              <Phone size={16} className="text-gold shrink-0 mt-0.5" /> +234 09032223878
            </li>
            <li className="flex gap-3">
              <Mail size={16} className="text-gold shrink-0 mt-0.5" /> shofirmfoods@gmail.com
            </li>
          </ul>
        </div>
      </div>
