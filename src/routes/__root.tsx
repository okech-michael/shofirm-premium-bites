...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ShoFirm Foods Limited" },
      { property: "og:description", content: "Premium Nigerian food manufacturer — trusted swallow flour, garri, cassava and more." },
