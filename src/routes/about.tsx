  ...
  head: () => ({
    meta: [
      { title: "About — ShoFirm Foods Limited" },
      {
        name: "description",
        content:
          "Learn about ShoFirm Foods Limited — a premium Nigerian food manufacturer committed to quality, safety and authentic flavor.",
      },
...
const timeline = [
  {
    y: "Origin",
    t: "Rooted in Nigerian tradition.",
    d: "ShoFirm Foods began with a simple commitment — bring premium-quality swallow flour products to Nigerian homes.",
  },
  {
    y: "Growth",
    t: "Modern processing meets heritage.",
    d: "We invested in modern milling and packaging to scale quality without compromise.",
  },
  {
    y: "Today",
    t: "Trusted nationwide.",
    d: "We supply retailers, wholesalers and distributors across all 36 states of Nigeria.",
  },
  {
    y: "Tomorrow",
    t: "Beyond borders.",
    d: "We're building on our reputation to bring premium Nigerian food to global tables.",
  },
];
    ...
    <SiteShell>
        ...
        <div className="container-pad grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="mt-5 text-5xl md:text-7xl font-display font-extrabold text-navy text-balance leading-[1.02]">
              Premium Nigerian food,{" "}
              <span className="text-gold italic font-light">made with care.</span>
            </h1>
            <p className="mt-8 text-lg text-foreground/75 leading-relaxed">
              ShoFirm Foods Limited is a Nigerian food manufacturer focused on premium swallow
              flours, garri, baby foods and specialty grains. Our promise is consistent quality,
      ...
      <section className="py-24 bg-background">
        <div className="container-pad grid md:grid-cols-2 gap-12">
          <div className="rounded-3xl bg-warm p-10">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-display font-extrabold text-navy">
              Premium quality, accessible to every Nigerian home.
            </h2>
            <p className="mt-5 text-foreground/70 leading-relaxed">
              To produce and distribute the finest food products — preserving tradition, exceeding
              safety standards, and earning trust at every table we serve.
            </p>
          </div>
          <div className="rounded-3xl bg-navy text-white p-10">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-display font-extrabold">
              A globally recognized Nigerian food brand.
            </h2>
            <p className="mt-5 text-white/75 leading-relaxed">
              To become the most trusted name in premium Nigerian food — at home and across the
              world.
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-warm">
        <div className="container-pad">
          <h2 className="text-4xl md:text-5xl font-display font-extrabold text-navy max-w-2xl">
            Our journey.
          </h2>
        ...
        <div className="container-pad">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div
                key={v.t}
                className="p-8 rounded-3xl bg-warm border border-border hover:border-gold hover:-translate-y-1 transition-all"
              >
      ...
      <section className="py-24 bg-warm">
        <div className="container-pad grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="mt-5 text-4xl md:text-5xl font-display font-extrabold text-navy leading-[1.05]">
              Manufacturing held to the highest standards.
            </h2>
            <p className="mt-6 text-foreground/70 leading-relaxed">
              Our facility operates under strict hygiene, traceability and quality-control
              protocols. Every batch is tested for moisture, purity and consistency before it
              reaches your shelf.
            </p>
            <ul className="mt-6 space-y-3 text-foreground/80">
              {[
                "NAFDAC-aligned safety standards",
                "Modern milling and packaging lines",
                "Traceable raw material sourcing",
                "Trained quality control team",
              ].map((b) => (
